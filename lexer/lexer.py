...
INT_DLM  = WHTSPC_DLM + ARITH_OPRTR + REL_OPRTR + LOGIC_OPRTR + ';' + ','
FLT_LIT_DLM = WHTSPC_DLM + ARITH_OPRTR + REL_OPRTR + ';' + ','
STRG_DLM = WHTSPC_DLM + '; ,'
BRC_DLM = WHTSPC_DLM + '{'
...
class Lexer:
    ...
    def make_comma(self, tokens, errors):
        start_pos = self.pos.copy()
        self.advance()  # ,
        if self.current_char is None or self.current_char in CMPLX_DLM or self.current_char in NUM:
