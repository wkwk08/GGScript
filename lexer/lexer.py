...
COMM_STRt_DLM = WHTSPC_DLM + ALPHANUM   # start delimiters: whitespace + alphanum
COMM_END_DLM = WHTSPC_DLM              # end delimiters: whitespace only
...
class Lexer:
    ...
    def make_plus_or_increment(self, tokens, errors):
        ...
        if self.current_char == '+':
            ...
            if self.current_char in CMPLX_DLM + CLBRCKT_DLM + WHTSPC_DLM or self.current_char is None:
